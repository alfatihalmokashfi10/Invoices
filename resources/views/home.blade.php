				...
				<div class="row row-sm">
									...
									<div class="d-flex">
										...
										<span class="float-right my-auto mr-auto">
											...
											<span class="text-white op-7">
                                                <?php $invoice=App\models\invoice::count() ?>
                                                @if($invoice>0)
                                            100%
                                            @else 0%
                                            @endif
					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-warning-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-12 text-white"> اجمالي الفواتير المدفوعه جزئياً </h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-danger-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-12 text-white">اجمالي الفواتير الغير مدفوعه </h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
										...
										<span class="float-right my-auto mr-auto">
											...
											<span class="text-white op-7">
                                                <?php $invoice=App\models\invoice::count() ?>
                                                @if($invoice>0)
                                                {{round( \App\models\invoice::where('Value_Status',2)->count()
                                                /\App\models\invoice::count()*100,2)}}%
