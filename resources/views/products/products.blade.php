        ...
        <div class="card mg-b-20">
            <div class="card-header pb-0">
                ...
                <div class="d-flex justify-content-between">
                        ...
                        <a class="btn btn-primary btn-block" data-effect="effect-scale"
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="product" class="table key-buttons text-md-nowrap">
                        <thead>
                            <tr>
                            ...
                            @foreach ($products as $x)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        data-name="{{ $x->product_name }}" data-id="{{ $x->id }}"
