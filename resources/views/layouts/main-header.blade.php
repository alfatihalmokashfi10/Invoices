								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<span  class="badge badge-pill badge-warning mr-auto my-auto float-left"><a href="/noti_read" >
                                                قراءة كل الاشعارات </a> </span>
										</div> <div id="notifications_count">
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">  الاشعارات الغير مقروءة :{{ auth()->user()->unreadNotifications->count() }}  </p>
									</div></div>
									<div class="main-notification-list Notification-scroll" id="unreadNotifications">

                                        @foreach (Auth()->user()->unreadNotifications as $notification)
										<a class="d-flex p-3 border-bottom" href="{{ url('notiInvoicesDetails') }}/{{$notification->data['invoice_id']}}">
